...
def onCamera(questions,choices,ans,vid):
    ...
    errorimg = cv2.resize(img, (widthImg, heightImg))
    ...
    try:
        ...
        if biggestPoints.size != 0 and gradePoints.size != 0:
            ...
            for x in range (0,questions):
                ...
                if abs(arr[myIndexVal[0][0]] - avsum)/avsum > .5:
            ...
            cv2.putText(imgRawGrade,str(int(score))+"%",(70,100)
                        ,cv2.FONT_HERSHEY_COMPLEX,3,(100,255,0),3) # ADD THE GRADE TO NEW IMAGE
        ...
        #cv2.imshow("Final Result", errorimg)
